                ...
                <div class="table-responsive">
                  <table class="table table-hover table-sm">
                   ...
                   <tbody>
                      <?php
                      $no=1;
                      $Rekap=mysqli_query($conn, "SELECT * FROM tb_daftar WHERE lb_daf='$lembaga' GROUP BY lb_daf");
                      $row=mysqli_fetch_object($Rekap);
                      ?>
                      <tr>
                      ...
                      <tfoot>
                        <tr>
                          <td align="left">
                            <a href="ekspor/pg_rekap?lembaga=<?= $row->lb_daf; ?>" class="btn btn-sm btn-success">Ekspor</a>
                          </td>
                          <td align="right"><b>Total Pendaftar</b></td>
                          <td colspan="3" align="center">
                           <b>
                            <?php
                              $Semua=mysqli_query($conn, "SELECT COUNT(id_p) AS semua FROM tb_daftar WHERE lb_daf='$lembaga'");
                ...
                <div class="table-responsive">
                  <table class="table table-hover table-sm">
                   ...
                   <tbody>
                        <?php
                        $no=1;
                        $Unduh=mysqli_query($conn, "SELECT * FROM tb_daftar WHERE lb_daf='$lembaga' GROUP BY lb_daf");
                        $rows=mysqli_fetch_object($Unduh);
                        ?>
                        <tr>
                          <td><small>Data Pendaftar</small></td>
                          <td>
                            <a href="ekspor/pg_ekspdf?lembaga=<?= $rows->lb_daf; ?>"><i class="fas fa-cloud-download-alt"></i></a>
                          </td>
                        </tr>
                        <tr>
                          <td><small>Berkas Pendaftaran</small></td>
                          <td>
