...
<head>
  ...
  <title>Penerimaan Santri Baru || PPDU</title>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <?php
          $menunggu = mysqli_query($conn, "SELECT COUNT(id_p) AS total FROM tb_daftar WHERE st_pdf='Menunggu'");
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <?php
          $pdf = mysqli_query($conn, "SELECT * FROM tb_daftar WHERE st_pdf='Menunggu'");
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="pg_profil" class="dropdown-item">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pg_pendaftaran" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pendaftaran</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pg_yayasan" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Yayasan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pg_app" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Aplikasi</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pg_user" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>User</p>
                </a>
              </li>
