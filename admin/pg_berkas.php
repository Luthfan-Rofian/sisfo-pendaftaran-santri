              ...
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  <div class="btn-group btn-sm">
                      ...
                      <div class="dropdown-menu">
                          <a href="pg_berkas" class="dropdown-item btn btn-outline-dark btn-sm">Semua</a>
                        <?php
                        ...
                        ?>
                          <a href="pg_berkas?lembaga=<?= $tl->nm_lembaga; ?>" class="dropdown-item btn btn-outline-dark btn-sm"><?= $tl->sk_lembaga; ?></a>
                        <?php } ?>
                      </div>
                  </div>
                </h3>
