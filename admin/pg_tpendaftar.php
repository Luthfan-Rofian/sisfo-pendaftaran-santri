                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select name="lb_daf" class="form-control" required />
                              ...
                              ?>
                              <option value="<?= strip_tags($tl->nm_lembaga); ?>">
                                <?= strip_tags($tl->nm_lembaga); ?>
                              </option>
                              <?php } ?>
                            </select>
                          </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="ug_pdf" placeholder="Contoh : 200000 (tanpa titik, koma atau spasi)" class="form-control" onkeypress="return AngkaSaja(event)">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
...
<script src="../assets/plugins/toastr/alert2.js"></script>
  <script>
    ...
    var charCode = (evt.which) ? evt.which : event.keyCode
     if (charCode > 31 && (charCode < 48 || charCode > 57)){
        toastr.error('Isikan hanya angka saja...')
        return false;
     };
    return true;
    }
