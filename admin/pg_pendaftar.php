        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="#" onclick="window.history.go(0);">Pendaftar</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <h3 class="card-title">
                  ...
                  <div class="btn-group btn-sm">
                      ...
                      <div class="dropdown-menu">
                        ...
                        <a href="#" class="dropdown-item toggle-vis btn btn-outline-dark btn-xs" data-column="2">Nama</a>
                        <a href="#" class="dropdown-item toggle-vis btn btn-outline-dark btn-xs" data-column="3">ID</a>
                        <a href="#" class="dropdown-item toggle-vis btn btn-outline-dark btn-xs" data-column="4">Lembaga</a>
                        <a href="#" class="dropdown-item toggle-vis btn btn-outline-dark btn-xs" data-column="5">Status</a>
                        <a href="#" class="dropdown-item toggle-vis btn btn-outline-dark btn-xs" data-column="6">Mode</a>
                ...
                <form action="<?= $_SERVER['PHP_SELF']; ?>" method="post">
                  <table class="table table-striped table-bordered table-sm" id="data1">
                    ...
                    <tbody>
                      <?php
                      $no=1;
                      $pdf = mysqli_query($conn, "SELECT * FROM tb_daftar ORDER BY id_daf ASC");
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          if ($md=='online') {
                            ?>
                            <span class="badge badge-primary badge-xs">Online</span>
                            <?php
                          }
                          if ($md=='offline') {
                            ?>
                        ...
                        <td class="text-center">
                          <div class="btn-group btn-sm">
                              ...
                              <div class="dropdown-menu">
                                ...
                                <a title="Hapus" href="#" class="dropdown-item btn-sm" onClick="konfirmasi('del_data?idpdf=<?= $pd->id_p; ?>');">Hapus Data</i>
                                </a>
                              </div>
                          </div>
                        </td>
