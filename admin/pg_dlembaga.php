...
$id=$_GET['idl'];
$Lembaga = "SELECT * FROM tb_lembaga WHERE id_lembaga='$id'";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#" onclick="window.location='pg_yayasan'">Yayasan</a></li>
                ...
                <table class="table table-sm">
                  <form action="a_elembaga.php" method="post">
                    ...
                    <tr>
                      ...
                      <td><input type="text" name="nm_lembaga" value="<?= $tl->nm_lembaga; ?>" class="form-control" required /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><input type="text" name="gl_lembaga" value="<?= $glmb->st_gelombang; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
