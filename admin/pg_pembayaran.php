            ...
            <div class="card card-outline card-info">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  <div class="btn-group btn-sm">
                      <button id="btnGroupDrop1" type="button" class="btn btn-dark btn-sm mt-1 dropdown-toggle" data-toggle="dropdown"><small>Pilih Lembaga</small></button>
                      <div class="dropdown-menu">
                          <a href="pg_pembayaran" class="dropdown-item btn btn-outline-dark btn-sm">Semua</a>
                        <?php
                        ...
                        ?>
                          <a href="pg_pembayaran?lembaga=<?= $tl->nm_lembaga; ?>" class="dropdown-item btn btn-outline-dark btn-sm"><?= $tl->sk_lembaga; ?></a>
                        <?php } ?>
                      </div>
                  </div>
                </h3>
              ...
              <div class="table-responsive">
                <div class="card-body">
                  <table class="table table-striped table-bordered table-sm" id="data1">
                    ...
                    <tbody>
                      <?php
                      if (empty($_GET['lembaga'])){
                        $no=1;
                        $lembaga=$_GET['lembaga'];
                        $pdf = mysqli_query($conn, "SELECT * FROM tb_daftar");
...
<script>
    ...
    var charCode = (evt.which) ? evt.which : event.keyCode
     if (charCode > 31 && (charCode < 48 || charCode > 57)){
        toastr.error('Isikan angka saja tanpa tanda baca')
        return false;
     };
    return true;
    }
